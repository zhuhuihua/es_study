...
public class GenerageData {
	...
	public static String getRandomCCOLLECTIONADDRESS() {
		String ccollectionaddress1[] = { "山东路", "江西路", "合肥路", "哈尔滨路", "劲松三路",
				"辽阳西路", "长沙路", "昌乐路", "敦化路", "镇江路", "镇江南路" };
		String ccollectionaddress2[] = { "延吉路", "宁夏路", "银川西路", "重庆南路", "福州北路",
				"辽阳东路", "香港中路", "东海西路", "郑州路", "株洲路", "九水路" };
	...
	public static void WriteStringToTxt() {
		System.out.println("准备生成：" + count + "条数据，到目录：" + defaultFilePath
				+ fileName + suffix);
	...
	private static void printHELP() {
		System.out
				.println("用法说明：[commond] | [options [-c count] [-p path] [-f filename] [-x suffix] [-n singlefilecount]]");
